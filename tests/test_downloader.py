...
class TestDownload:
    ...
    def test_download_success(self, downloader, tmp_project_dir, mock_video_info):
        ...
        download_path = tmp_project_dir / "downloads" / "Test Video Title_dQw4w9WgXcQ.mp4"
    ...
    def test_download_with_quality_1080p(self, downloader, tmp_project_dir, mock_video_info):
    ...
    def test_download_with_custom_filename(self, downloader, tmp_project_dir, mock_video_info):
    ...
    def test_download_sanitizes_filename(self, downloader, tmp_project_dir, mock_video_info):
    ...
    def test_download_file_not_found(self, downloader, tmp_project_dir, mock_video_info):
    ...
    def test_download_converts_extension_to_mp4(self, downloader, tmp_project_dir, mock_video_info):
...
class TestDownloadErrorHandling:
    ...
    def test_download_error_reports_to_reporter(self, downloader_with_reporter, mock_reporter):
        ...
        with patch("yt_dlp.YoutubeDL") as mock_ydl_class:
            ...
            error_events = [e for e in mock_reporter.reported_events
                          if e.status == DependencyStatus.ERROR]
            assert len(error_events) > 0
            assert "Network error" in error_events[-1].message

    def test_download_file_not_found_reports_error(self, downloader_with_reporter, mock_reporter, mock_video_info, tmp_project_dir):
...
class TestDownloadAudioOnly:
    ...
    def test_download_audio_only_success(self, downloader, tmp_project_dir, mock_video_info):
        ...
        with patch("yt_dlp.YoutubeDL") as mock_ydl_class:
            ...
            mock_ydl.__exit__ = MagicMock(return_value=False)
            mock_ydl.extract_info.return_value = mock_video_info
            mock_ydl.prepare_filename.return_value = str(audio_path.with_suffix(".webm"))
            mock_ydl_class.return_value = mock_ydl
    ...
    def test_download_audio_only_uses_correct_format(self, downloader, tmp_project_dir, mock_video_info):
...
class TestProgressHook:
    ...
    def test_progress_hook_reports_downloading_to_reporter(self, downloader_with_reporter, mock_reporter):
    ...
    def test_progress_hook_reports_finished_to_reporter(self, downloader_with_reporter, mock_reporter):
    ...
    def test_progress_hook_no_report_without_active_key(self, downloader_with_reporter, mock_reporter):
...
class TestReporterIntegration:
    ...
    def test_download_reports_starting_status(self, downloader_with_reporter, mock_reporter, mock_video_info, tmp_project_dir):
    ...
    def test_download_reports_done_on_success(self, downloader_with_reporter, mock_reporter, mock_video_info, tmp_project_dir):
        ...
        with patch("yt_dlp.YoutubeDL") as mock_ydl_class:
            ...
            done_events = [e for e in mock_reporter.reported_events
                          if e.status == DependencyStatus.DONE]
            assert len(done_events) > 0

    def test_download_key_includes_video_id(self, downloader_with_reporter, mock_reporter, mock_video_info, tmp_project_dir):
...
class TestDownloadVideoHelper:
    ...
    def test_download_video_helper_success(self, tmp_project_dir, mock_video_info, monkeypatch):
    ...
    def test_download_video_helper_with_quality(self, tmp_project_dir, mock_video_info, monkeypatch):
...
class TestQualityFormatMapping:
    ...
    def test_quality_format_options(self, downloader, tmp_project_dir, mock_video_info, quality, expected_height):
    ...
    def test_unknown_quality_defaults_to_best(self, downloader, tmp_project_dir, mock_video_info):
